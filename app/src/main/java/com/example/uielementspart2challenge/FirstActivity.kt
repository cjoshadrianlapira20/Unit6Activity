...
class FirstActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        songsArray.addAll(resources.getStringArray(R.array.Franco))
        songsArray.addAll(resources.getStringArray(R.array.Incubus))
        songsArray.addAll(resources.getStringArray(R.array.ThreeEleven))
        //Map the views
